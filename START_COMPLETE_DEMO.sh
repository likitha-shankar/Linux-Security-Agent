...
echo ""
echo "Log file commands (using current log: $LATEST_LOG):"
echo "  - Live tail:        tail -f $LATEST_LOG"
echo "  - View attacks:     sudo grep -E 'PORT_SCANNING|C2_BEACONING' $LATEST_LOG"
echo "  - View high-risk:   sudo grep 'HIGH RISK DETECTED' $LATEST_LOG"
echo "  - View anomalies:   sudo grep 'ANOMALY DETECTED' $LATEST_LOG"
echo ""
